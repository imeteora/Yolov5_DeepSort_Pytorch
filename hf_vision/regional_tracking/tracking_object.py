...
class TrackingObject(RawObject):
    def __init__(self, pos, feature, id: int = -1):
        ...
        self.crossed_lines = []  # 最近穿越的警戒线编号 uuid
    ...
    def update(self, pos: [int]):
        ...
        self.trajectory.append(self.anchor_pt)  # kalman滤波之后生成的标记点坐标
    ...
    def description(self) -> str:
        return f'{self.id} - {self.anchor_pt}'
