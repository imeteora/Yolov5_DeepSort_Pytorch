...
class Ui_EditorMainWindow(object):
    def setupUi(self, EditorMainWindow):
        ...
        self.actionStartDetect.setIcon(icon11)
        self.actionStartDetect.setObjectName("actionStartDetect")
        self.actionPauseDetect = QtWidgets.QAction(EditorMainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon/icons/暂停.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPauseDetect.setIcon(icon12)
        self.actionPauseDetect.setObjectName("actionPauseDetect")
        self.actionStopDetect = QtWidgets.QAction(EditorMainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icon/icons/停止.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStopDetect.setIcon(icon13)
        self.actionStopDetect.setObjectName("actionStopDetect")
        self.actionConfigYoloV5Weights = QtWidgets.QAction(EditorMainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icon/icons/AI、智能大脑-09.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionConfigYoloV5Weights.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icon/icons/环保平台-智能巡检.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionConfigReIdSSWeights.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icon/icons/智能、连接-02.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionConfigReIdSSYaml.setIcon(icon16)
