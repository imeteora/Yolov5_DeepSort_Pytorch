...
# Form implementation generated from reading ui file 'hf_vision/qt/editor-main-window.ui'
#
...
class Ui_EditorMainWindow(object):
    def setupUi(self, EditorMainWindow):
        ...
        EditorMainWindow.resize(1024, 768)
        ...
        self.menuDraw = QtWidgets.QMenu(self.menu_Edit)
        ...
        self.actionLine = QtWidgets.QAction(EditorMainWindow)
        self.actionLine.setObjectName("actionLine")
        self.actionPolygon_Warning_Area = QtWidgets.QAction(EditorMainWindow)
        self.actionPolygon_Warning_Area.setObjectName("actionPolygon_Warning_Area")
        self.actionSourceLocalCamera = QtWidgets.QAction(EditorMainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icon/icons/摄像头.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSourceLocalCamera.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icon/icons/5摄像头.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSourceRemoteCamera.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/icons/file-mp4.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSourceMediaVideo.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/icons/插入图片.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSourceStaticImage.setIcon(icon8)
        self.actionSourceStaticImage.setObjectName("actionSourceStaticImage")
        self.actionStartDetect = QtWidgets.QAction(EditorMainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/icons/播放2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStartDetect.setIcon(icon9)
        self.actionStartDetect.setObjectName("actionStartDetect")
        self.actionPauseDetect = QtWidgets.QAction(EditorMainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icon/icons/暂停.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPauseDetect.setIcon(icon10)
        self.actionPauseDetect.setObjectName("actionPauseDetect")
        self.actionStopDetect = QtWidgets.QAction(EditorMainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icon/icons/停止.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStopDetect.setIcon(icon11)
        self.actionStopDetect.setObjectName("actionStopDetect")
        self.actionConfigYoloV5Weights = QtWidgets.QAction(EditorMainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon/icons/AI、智能大脑-09.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionConfigYoloV5Weights.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icon/icons/环保平台-智能巡检.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionConfigReIdSSWeights.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icon/icons/智能、连接-02.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionConfigReIdSSYaml.setIcon(icon14)
        ...
        self.menuDraw.addAction(self.actionPolygon_Warning_Area)
        ...
        self.menu_Edit.addAction(self.menuDraw.menuAction())
        ...
        self.menu_Project.addAction(self.actionStartDetect)
        self.menu_Project.addAction(self.actionPauseDetect)
        ...
        self.toolBar_3.addAction(self.actionStartDetect)
        self.toolBar_3.addAction(self.actionPauseDetect)
    ...
    def retranslateUi(self, EditorMainWindow):
        ...
        self.menuDraw.setTitle(_translate("EditorMainWindow", "Draw"))
        ...
        self.actionLine.setText(_translate("EditorMainWindow", "Line (Cordon)"))
        self.actionPolygon_Warning_Area.setText(_translate("EditorMainWindow", "Polygon (Warning Area)"))
        ...
        self.actionStartDetect.setText(_translate("EditorMainWindow", "Start"))
        self.actionPauseDetect.setText(_translate("EditorMainWindow", "Pause"))
